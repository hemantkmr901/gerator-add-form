...
export const StatusCompleteSizeMdStateFocused = ({ className }) => {
  return (
    <svg
      className={`status-complete-size-md-state-focused ${className}`}
      fill="none"
      height="36"
      viewBox="0 0 36 36"
      width="36"
    ...
    >
      <g className="g" filter="url(#filter0_d_2_25761)">
        <g className="g" clipPath="url(#clip0_2_25761)">
          <path
            className="path"
      ...
      <defs className="defs">
        ...
        >
          ...
          <feMorphology
            ...
            operator="dilate"
            radius="4"
            result="effect1_dropShadow_2_25761"
          />
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_2_25761" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_2_25761"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_2_25761">
          <path
            className="path"
            d="M0 16C0 7.16344 7.16344 0 16 0C24.8366 0 32 7.16344 32 16C32 24.8366 24.8366 32 16 32C7.16344 32 0 24.8366 0 16Z"
            fill="white"
