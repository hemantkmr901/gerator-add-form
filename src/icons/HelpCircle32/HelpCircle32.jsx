...
export const HelpCircle32 = ({ className }) => {
  return (
    <svg
      className={`help-circle-32 ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
    ...
    >
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_381_747">
