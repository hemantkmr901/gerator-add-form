...
export const FileTypeDefaultPdfTypeGray = ({ className }) => {
  return (
    <svg
      className={`file-type-default-pdf-type-gray ${className}`}
      fill="none"
      height="40"
      viewBox="0 0 40 40"
      width="40"
    ...
    >
      <mask className="mask" height="40" id="mask0_214_11798" maskUnits="userSpaceOnUse" width="32" x="4" y="0">
        <path
          className="path"
          d="M4 4C4 1.79086 5.79086 0 8 0H24L36 12V36C36 38.2091 34.2091 40 32 40H8C5.79086 40 4 38.2091 4 36V4Z"
          fill="url(#paint0_linear_214_11798)"
        />
      </mask>
      <g className="g" mask="url(#mask0_214_11798)">
        <path
          className="path"
          d="M4 4C4 1.79086 5.79086 0 8 0H24L36 12V36C36 38.2091 34.2091 40 32 40H8C5.79086 40 4 38.2091 4 36V4Z"
          fill="#F2F4F7"
