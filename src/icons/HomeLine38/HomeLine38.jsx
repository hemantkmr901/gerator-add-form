...
export const HomeLine38 = ({ color = "#667085", className }) => {
  return (
    <svg
      className={`home-line-38 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
