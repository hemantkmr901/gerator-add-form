...
export const StepIconBase20 = ({ className }) => {
  return (
    <svg
      className={`step-icon-base-20 ${className}`}
      fill="none"
      height="44"
      viewBox="0 0 44 44"
      width="44"
    ...
    >
      <g className="g" filter="url(#filter0_d_2_26421)">
        <g className="g" clipPath="url(#clip0_2_26421)">
          <path
            className="path"
      ...
      <defs className="defs">
        ...
        >
          ...
          <feMorphology
            ...
            operator="dilate"
            radius="4"
            result="effect1_dropShadow_2_26421"
          />
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_2_26421" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_2_26421"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_2_26421">
          <path
            className="path"
            d="M0 20C0 8.95431 8.95431 0 20 0C31.0457 0 40 8.95431 40 20C40 31.0457 31.0457 40 20 40C8.95431 40 0 31.0457 0 20Z"
            fill="white"
