...
export const AlertCircle26 = ({ color = "white", className }) => {
  return (
    <svg
      className={`alert-circle-26 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <g className="g" clipPath="url(#clip0_2_591)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_2_591">
