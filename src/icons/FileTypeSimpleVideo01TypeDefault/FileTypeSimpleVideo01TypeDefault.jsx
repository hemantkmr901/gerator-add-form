...
export const FileTypeSimpleVideo01TypeDefault = ({ className }) => {
  return (
    <svg
      className={`file-type-simple-video-01-type-default ${className}`}
      fill="none"
      height="40"
      viewBox="0 0 40 40"
      width="40"
    ...
    >
      <path
        ...
        strokeWidth="1.5"
      />
      <path className="path" d="M24 0.5V8C24 10.2091 25.7909 12 28 12H35.5" stroke="#D0D5DD" strokeWidth="1.5" />
      <g className="g" clipPath="url(#clip0_214_11732)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_214_11732">
          <rect className="rect" fill="white" height="18" transform="translate(11 15)" width="18" />
        </clipPath>
      </defs>
    </svg>
  );
