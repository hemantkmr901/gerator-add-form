...
export const StatusCompleteSizeSmStateFocused = ({ className }) => {
  return (
    <svg
      className={`status-complete-size-sm-state-focused ${className}`}
      fill="none"
      height="28"
      viewBox="0 0 28 28"
      width="28"
    ...
    >
      <g className="g" filter="url(#filter0_d_2_25758)">
        <g className="g" clipPath="url(#clip0_2_25758)">
          <path
            className="path"
      ...
      <defs className="defs">
        ...
        >
          ...
          <feMorphology
            ...
            operator="dilate"
            radius="4"
            result="effect1_dropShadow_2_25758"
          />
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_2_25758" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_2_25758"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_2_25758">
          <path
            className="path"
            d="M0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12Z"
            fill="white"
