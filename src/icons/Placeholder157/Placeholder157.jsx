...
export const Placeholder157 = ({ color = "#6941C6", className }) => {
  return (
    <svg
      className={`placeholder-157 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <g className="g" clipPath="url(#clip0_1_33311)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_1_33311">
