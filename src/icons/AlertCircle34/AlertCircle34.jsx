...
export const AlertCircle34 = ({ color = "#667085", className }) => {
  return (
    <svg
      className={`alert-circle-34 ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
    ...
    >
      <g className="g" clipPath="url(#clip0_2_601)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_2_601">
