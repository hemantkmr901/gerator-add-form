...
export const StepIconBase23 = ({ className }) => {
  return (
    <svg
      className={`step-icon-base-23 ${className}`}
      fill="none"
      height="36"
      viewBox="0 0 36 36"
      width="36"
    ...
    >
      <g className="g" filter="url(#filter0_d_2_26588)">
        <g className="g" clipPath="url(#clip0_2_26588)">
          <path
            className="path"
      ...
      <defs className="defs">
        ...
        >
          ...
          <feMorphology
            ...
            operator="dilate"
            radius="4"
            result="effect1_dropShadow_2_26588"
          />
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_2_26588" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_2_26588"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_2_26588">
          <path
            className="path"
            d="M0 16C0 7.16344 7.16344 0 16 0C24.8366 0 32 7.16344 32 16C32 24.8366 24.8366 32 16 32C7.16344 32 0 24.8366 0 16Z"
            fill="white"
