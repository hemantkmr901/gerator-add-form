...
import { Provider } from "./AddSpareContext";
...
import AddSpareStep1 from "../../components/AddSpareFormComponent/AddSpareStep1";
import AddSpareStep2 from "../../components/AddSpareFormComponent/AddSpareStep1";
import AddSpareStep3 from "../../components/AddSpareFormComponent/AddSpareStep1";
                ...
                <div className="page-header-wrapper">
                  <div className="div-5">
                    <Breadcrumbs
                      ...
                      breadcrumbButtonText1="Add Spare"
                      breakpoint="desktop"
                    ...
                    <div className="content-12">
                      <div className="text-and-supporting-4">
                        <div className="text-22">Add Spare Listing</div>
