  ...
  if (isLoading) {
    ...
    if(data.length > 0){
      content =  data.map(device => 
        ...
        <img className="rectangle-25" alt="Rectangle" src={device.featureImageLink} />
        <img className="divider-60" alt="Divider" src="/img/divider-4.svg" />
        <Link to={`/devices/${device.id}/${device.title}`} className="title-link"><p className="text-124">{device.title}</p></Link>
            ...
            <div className="frame-60">
              ...
              <div className="group-281">
                <div className="div-13">
                  ...
                  <div className="text-wrapper-18">{device.location}</div>
                </div>
              </div>
              ...
              <div className="group-293">
                ...
                <div className="buttons-button-35">
                  ...
                  <div className="text-padding-18">
                    <div className="text-123">Edit</div>
                  </div>
                </div>
                </Link>
              </div>
