  ...
  return (
    <Formik 
      ...
      validationSchema = {Yup.object({
        ...
        title:Yup.string().max(70,'Must be 70 characters or less'),
      })}
    ...
    >
      ...
      <div className="group">
        <div className="overlap">
          ...
          <img className="rectangle-2" alt="Rectangle" src="/img/rectangle-5.png" />
          ...
          <p className="text-10">
            ...
            <span className="span">wned, </span>
            <span className="span">
              USED, FULLY REFURBISHED 1984 gARAVENTA ACCESSIBILITY WRISTVIEW STREPTOCOCCUS A HYALURONIDASE ANTIBODY
              DETECTION, IDENTIFICATION REAGENTS FOR RENT / LEASE
            </span>
          </p>
              ...
              <div className="group-19">
                <div className="frame-6">
                  <div className="frame-7">
                    ...
                    <div className="supporting-text-2">India, New Delhi</div>
                  </div>
                  <div className="frame-7">
                    <img className="overlap-group-wrapper" alt="Calendar" src="/img/calendar.png" />
                    <div className="supporting-text-2">April 9, 2023</div>
                  </div>
                </div>
              </div>
          ...
          <div className="pagination-wrapper">
            <div className="pagination">
              ...
              <button className="button-wrap-2">
                <button className="buttons-button-8">
                  <div className="text-padding-4">
